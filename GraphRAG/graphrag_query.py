...
def extract_entities(question, repeat=0):
    ...
    return cached(cache_key("extract_entities", CHAT_MODEL, question, repeat), compute)
...
def answer_with_subgraph(question, facts, repeat=0):
    ...
    return cached(cache_key("answer_with_subgraph", CHAT_MODEL, question, context_block, repeat), compute)


def answer_question(question, repeat=0, verbose=True):
    mentions = extract_entities(question, repeat=repeat)
