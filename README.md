...
> **최종 업데이트**: 2026-07-13: 지식 그래프 파이프라인(Neo4j 적재 + **Bloom 시각화**) 및 모델 구성 비교표(ATLOP 논문 vs Baseline 재현 vs RoBERTa+PU) 추가.
>
...
| 7/15 – 7/16 | Ablation·하이퍼파라미터 탐색, 검증된 개선 결합(E5), 예측 triple Neo4j 적재·Bloom 시각화 구축 | 실험 표, 학습 곡선, KG 적재 스크립트 |
